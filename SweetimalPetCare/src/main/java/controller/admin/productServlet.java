...
public class productServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<ProductCategory> listCate = pDAO.getAllCate();
        ArrayList<Brand> listBrand = pDAO.getAllBrands();
        System.out.println(listCate);
        if (listCate == null) {
            listCate = new ArrayList<>(); // <-- KHÔNG BAO GIỜ ĐỂ NULL
        }
        if (listBrand == null) {
            listBrand = new ArrayList<>(); // <-- KHÔNG BAO GIỜ ĐỂ NULL
        }
