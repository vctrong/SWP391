    ...
    <script>
        ...
        function recalcTotals() {
            ...
            rows.forEach(row => {
                ...
                if (calcUnit) calcUnit.textContent = formatVND(unit);
                if (calcLine) calcLine.textContent = formatVND(lineTotal).replace(/\u00A0₫$/,'');
