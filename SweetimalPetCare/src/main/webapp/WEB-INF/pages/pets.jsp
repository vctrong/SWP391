<%-- Document : pet Created on : Oct 2, 2025, 8:54:24 AM Author : Lim Thế Toàn -
CE190616 --%>
  ...
  <body class="bg-gray-50 text-gray-800">
    ...
    <main class="container mx-auto px-6 py-24">
      ...
      <c:if test="${not empty errorMessage}">
        ...
        >
          <div
            class="bg-red-100 border border-red-400 text-red-700 px-6 py-4 rounded-2xl shadow-lg flex items-center gap-4"
          >
            ...
            <button
              onclick="document.getElementById('deleteErrorPopup').style.display='none'"
              class="text-red-900 font-bold hover:text-red-700"
            >
              &times;
            </button>
          </div>
        ...
        <script>
          setTimeout(function () {
            var el = document.getElementById("deleteErrorPopup");
      ...
      <section class="mb-12">
        <div class="flex justify-center">
          <div class="inline-block bg-blue-50 shadow-md px-4 py-2 rounded-lg">
            <h2 class="text-2xl font-bold text-blue-700 text-center m-0">
              Danh sách thú cưng
            </h2>
          </div>
        </div>
        ...
        <div class="mt-4">
          <div
            class="bg-yellow-50 border-l-4 border-yellow-400 text-yellow-700 p-4 rounded"
          >
            <p class="m-0">
              Lưu ý: <strong>Thú cưng đã có lịch đặt sẽ không thể xóa</strong>.
              Nếu bạn muốn xóa thú cưng đã có lịch, vui lòng
              <a
                class="text-yellow-800 underline font-semibold"
                ...
                <tr class="hover:bg-gray-50">
                  ...
                  <td class="px-4 py-3">
                    <c:forEach var="s" items="${speciesList}">
                      <c:if test="${s.id == p.speciesId}"> ${s.name} </c:if>
                    </c:forEach>
                  </td>
                  ...
                  <td class="px-4 py-3 text-center space-x-2">
                    ...
                    <form action="pets" method="post" class="inline">
                      ...
                      <button
                        type="button"
                        onclick="if (confirmDelete(this.form)) this.form.submit();"
