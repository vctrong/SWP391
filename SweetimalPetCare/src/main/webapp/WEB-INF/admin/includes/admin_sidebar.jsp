        ...
        <ul class="space-y-1">
            ...
            <li>
                            <a href="${pageContext.request.contextPath}/admin/dashboard"
                                class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-gray-100 ${fn:endsWith(current, '/admin/dashboard') ? 'nav-active' : ''}">
            ...
            <li>
                            <a href="${pageContext.request.contextPath}/admin/service"
                                class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-gray-100 ${fn:endsWith(current, '/admin/service') ? 'nav-active' : ''}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <li>
                            <a href="${pageContext.request.contextPath}/admin/product"
                                class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-gray-100 ${fn:endsWith(current, '/admin/product') ? 'nav-active' : ''}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <li>
                            <a href="${pageContext.request.contextPath}/admin/personnel"
                                class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-gray-100 ${fn:endsWith(current, '/admin/personnel') ? 'nav-active' : ''}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <li>
                            <a href="${pageContext.request.contextPath}/admin/booking"
                                class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-gray-100 ${fn:endsWith(current, '/admin/booking') ? 'nav-active' : ''}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <li>
                            <a href="${pageContext.request.contextPath}/admin/order"
                                class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-gray-100 ${fn:endsWith(current, '/admin/order') ? 'nav-active' : ''}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <li>
                            <a href="${pageContext.request.contextPath}/admin/contact"
                                class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-gray-100 ${fn:endsWith(current, '/admin/contact') ? 'nav-active' : ''}">
