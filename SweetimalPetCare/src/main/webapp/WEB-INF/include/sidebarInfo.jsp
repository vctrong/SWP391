        ...
        <div class="flex-1 overflow-y-auto p-4 bg-gray-50">
            ...
            <div class="mt-6">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <a href="${pageContext.request.contextPath}/profile?tab=overview" class="bg-white p-3 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-200 flex flex-col items-center">
