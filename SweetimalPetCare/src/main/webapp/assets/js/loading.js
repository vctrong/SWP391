...
(function () {
    ...
    if (typeof window !== 'undefined') {
        ...
        document.addEventListener('click', function (e) {
            ...
            if (a.dataset && a.dataset.noLoader !== undefined)
                return;
        ...
        document.addEventListener('submit', function (e) {
            ...
            if (!form)
                return;
            if (!(form.dataset && form.dataset.showLoader !== undefined))
                return;
        ...
        showLoader = function () {
            try {
                ...
                console.error('showLoader failed', e);
            }
            try {
                if (_loaderTimeout)
        ...
        hideLoader = function () {
            try {
                ...
                console.error('hideLoader failed', e);
            }
            try {
                if (_loaderTimeout) {
                    clearTimeout(_loaderTimeout);
